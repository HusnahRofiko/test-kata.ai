...
WebUI.setText(findTestObject('3. automation login/1. email'), GlobalVariable.gmail)

WebUI.setText(findTestObject('3. automation login/2. password'), GlobalVariable.password)

WebUI.click(findTestObject('3. automation login/3. btn sign in'))
